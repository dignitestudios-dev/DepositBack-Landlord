 ...
 <ImageGallery images={images} />
                    ...
                    <div className="bg-[#F3F8FF] w-[30em] rounded-2xl p-6">
                        ...
                        <div className="border-t pt-4 mt-4">
                            ...
                            <div>
                                <div className='bg-white flex justify-between rounded-2xl p-3 items-center mb-3'>
                                    <button className='font-[500]'><a href="#">Documents</a></button><br />
                                    <BsChevronRight />
                                </div>
                                ...
                                <div className='bg-white flex justify-between rounded-2xl p-3 items-center'>
                                    <button className='font-[500]'><a href="#">Deposit Tracker</a></button><br />
                                    <BsChevronRight />
                                </div>
                            </div>
